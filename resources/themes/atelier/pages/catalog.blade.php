<x-storefront-layout>
    ...
    <section class="etic-catalog" data-etic-catalog data-grid-columns="3">
        ...
        @if($collections->isNotEmpty())
            <nav class="etic-catalog__category-bar" aria-label="Ürün kategorileri">
        ...
        <div class="etic-catalog__controls">
            <button type="button" class="etic-catalog__control" data-catalog-filter-toggle aria-expanded="false">
                <span data-catalog-filter-label>Filtreler</span>
        ...
        <div class="etic-catalog__layout">
            <button type="button" class="etic-catalog__filters-backdrop" data-catalog-filter-close aria-label="Filtreleri kapat"></button>
            <aside class="etic-catalog__filters">
                <div class="etic-catalog__filters-head">
                    <h2>Filtreler</h2>
                    <button type="button" class="etic-catalog__filters-close" data-catalog-filter-close aria-label="Filtreleri kapat">
